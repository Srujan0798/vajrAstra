...
- **10 engine runs × 400 pages = 4,000 packs** (9 distinct engines; 7
  ...
  disclosed).
- **Free-OSS volume gap: 7.1%** (lower bound; measured on the 177 pages with
  a usable text layer; 63 legacy-font + 43 broken text layers among them —
  60% of layered pages are extraction-hostile).
...
with corrupted legacy text layers or thin layers are nulled, never ranked
